...
register(support_group, app_sources_phase, %w[AppReviewTracker.swift])

services_group = find_or_create_group(tickemo_group, "Services", "Tickemo/Services")
register(services_group, app_sources_phase, %w[LiveNotificationSettings.swift LiveNotificationService.swift])

screens_group = find_or_create_group(tickemo_group, "Screens", "Tickemo/Screens")
register(screens_group, app_sources_phase, %w[NotificationSettingsView.swift])
