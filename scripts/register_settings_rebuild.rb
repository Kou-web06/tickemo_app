...
register(screens_group, app_sources_phase, %w[
  MusicProviderPickerView.swift
...
register(support_group, app_sources_phase, %w[
  JoinedDateFormatting.swift
  SettingsPalette.swift
...
register(services_group, app_sources_phase, %w[
  ThemePreferenceService.swift
  HapticsPreferenceService.swift
  MusicProviderPreference.swift
...
register(tests_group, test_sources_phase, %w[
  JoinedDateFormattingTests.swift
  EarlyOfferServiceTests.swift
