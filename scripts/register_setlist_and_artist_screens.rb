...
register(screens_group, sources_phase, %w[SetlistEditorView.swift ArtistDetailView.swift])

components_group = find_or_create_group(tickemo_group, "Components", "Tickemo/Components")
register(components_group, sources_phase, %w[ArtistGridItemView.swift SetlistMarkerDivider.swift])

support_group = find_or_create_group(tickemo_group, "Support", "Tickemo/Support")
register(support_group, sources_phase, %w[ChekiRecordSetlist.swift ArtistGrouping.swift])
