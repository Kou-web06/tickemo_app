...
register(support_group, app_sources_phase, %w[RecordFormValidation.swift])
...
register(tests_group, test_sources_phase, %w[AppleMusicServiceTests.swift RecordFormValidationTests.swift])
