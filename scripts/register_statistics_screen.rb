...
register(screens_group, app_sources_phase, %w[StatisticsView.swift StatisticsRankingRowView.swift ArtistArchiveCardView.swift])

support_group = find_or_create_group(tickemo_group, "Support", "Tickemo/Support")
register(support_group, app_sources_phase, %w[StatisticsData.swift])
...
register(tests_group, test_sources_phase, %w[StatisticsDataTests.swift])
