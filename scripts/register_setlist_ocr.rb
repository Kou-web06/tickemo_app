...
register(support_group, app_sources_phase, %w[SetlistOcrCleanup.swift SetlistOcrRecognizer.swift])

components_group = find_or_create_group(tickemo_group, "Components", "Tickemo/Components")
register(components_group, app_sources_phase, %w[SetlistDraftEditorView.swift])

screens_group = find_or_create_group(tickemo_group, "Screens", "Tickemo/Screens")
register(screens_group, app_sources_phase, %w[SetlistOcrReviewView.swift])
...
register(tests_group, test_sources_phase, %w[SetlistOcrCleanupTests.swift])
