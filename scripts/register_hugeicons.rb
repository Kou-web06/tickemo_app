...
register(support_group, app_sources_phase, %w[HugeIconPath.swift HugeIcon.swift])

components_group = find_or_create_group(tickemo_group, "Components", "Tickemo/Components")
register(components_group, app_sources_phase, %w[HugeIconView.swift])
...
register(tests_group, test_sources_phase, %w[HugeIconPathTests.swift])
